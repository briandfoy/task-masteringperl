...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Task-MasteringPerl> or 
L<MetaCPAN|http://www.metacpan.org/module/Task::MasteringPerl>:

=over 4

=item *	L<http://search.cpan.org/dist/Task-MasteringPerl>

=item *	L<http://www.metacpan.org/module/Task::MasteringPerl>
